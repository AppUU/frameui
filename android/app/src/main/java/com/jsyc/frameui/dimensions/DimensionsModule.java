...
public class DimensionsModule extends ReactContextBaseJavaModule implements LifecycleEventListener {

    private ReactContext mReactContext;

    public DimensionsModule(ReactApplicationContext reactContext) {
        super(reactContext);
